...
def main():
    ...
    print(json.dumps(meta,indent=2));print(fixed[fixed.year.isin([2024,2030,2040,2050])].to_string(index=False));print(ret[ret.year.isin([2024,2030,2040,2050])].to_string(index=False))
